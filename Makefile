...
test: next/ngasm.stable.next.bin next/ngasm.next.next.bin
	@echo "Running unit tests."
	tests/run-all-tests next/ngasm.stable.next.bin next/ngasm.asm next/ngasm.next.next.bin next/ngasm.asm
